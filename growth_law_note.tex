...
\date{June 2026 \quad(\texttt{pcf-quadratic-growth} v0.1.0)}
...
(\texttt{https://doi.org/10.5281/zenodo.19491767}).
...
The verifier \texttt{verify\_structural.py} and harness \texttt{harness\_quad.py},
reproducing every numerical check (steps S1--S5), are available in the repository
\texttt{papanokechi/pcf-quadratic-growth}
(\url{https://github.com/papanokechi/pcf-quadratic-growth}).

\paragraph{AI-assistance disclosure.}
Prepared with AI assistance (GitHub Copilot; Anthropic Claude) for drafting,
computer-algebra verification, and manuscript preparation. The numerical
verification was obtained by running \texttt{verify\_structural.py} (mpmath,
$50$--$60$ digits); the author takes responsibility for the content and for the
placement of each claim within the four-grade epistemic partition.
